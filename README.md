...
I intend to continue working on this project first with an update of the existing models
to current libraries (likely using PyTorch this time) and later on (hopefully) improving the model with better architectures
and maybe more data.
